  ...
  methods: {
    ...
    async bindchooseavatar(res) {
      ...
      try {
        ...
        let {
          fileID
        } = await common_vendor.$s.uploadFile({
          filePath: avatarUrl,
          cloudPath,
          fileType: "image"
        });
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/WWW/linni/app/uni_modules/uni-id-pages/components/uni-id-pages-avatar/uni-id-pages-avatar.vue"]]);
