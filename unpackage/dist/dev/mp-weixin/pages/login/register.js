...
const _sfc_main = {
  ...
  methods: {
    ...
    toSmsCode() {
      common_vendor.index.navigateTo({
        url: `/uni_modules/uni-id-pages/pages/login/login-smscode?phoneNumber=${this.formData.mobile}&from='pwd'`
      });
    }
  }
};
if (!Array) {
  ...
  (_easycom_uni_easyinput2 + _easycom_uni_forms_item2 + _easycom_uni_tag2 + _easycom_uni_captcha2 + _easycom_uni_id_pages_agreements2 + _easycom_uni_forms2 + _easycom_uni_popup_dialog2 + _easycom_uni_popup2 + _easycom_uni_id_pages_sms_form2)();
}
...
if (!Math) {
  (_easycom_uni_easyinput + _easycom_uni_forms_item + _easycom_uni_tag + _easycom_uni_captcha + _easycom_uni_id_pages_agreements + _easycom_uni_forms + _easycom_uni_popup_dialog + _easycom_uni_popup + _easycom_uni_id_pages_sms_form)();
}
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    F: common_vendor.sr("captcha", "748ca9ec-15,748ca9ec-14"),
    G: common_vendor.o(($event) => $data.formData.captcha = $event),
    H: common_vendor.p({
      scene: "register",
      modelValue: $data.formData.captcha
    }),
    I: common_vendor.sr("agreements", "748ca9ec-16,748ca9ec-0"),
    J: common_vendor.p({
      scope: "register"
    }),
    ...
    M: common_vendor.o((...args) => $options.registerByEmail && $options.registerByEmail(...args)),
    N: common_vendor.o((...args) => $options.toLogin && $options.toLogin(...args)),
    O: common_vendor.sr("form", "748ca9ec-0"),
    P: common_vendor.p({
      value: $data.formData,
      rules: $data.rules,
    ...
    Q: common_vendor.sr("inputClose", "748ca9ec-18,748ca9ec-17"),
    R: common_vendor.o($options.dialogInputConfirm),
    S: common_vendor.p({
      mode: "input",
      title: "车牌号",
      placeholder: "请输入车牌号"
    }),
    T: common_vendor.sr("inputDialog", "748ca9ec-17"),
    U: common_vendor.p({
      type: "dialog"
    }),
    V: common_vendor.sr("smsCode", "748ca9ec-21,748ca9ec-20"),
    W: common_vendor.o(($event) => $data.formData.code = $event),
    X: common_vendor.p({
    ...
    Y: common_vendor.o($options.smsBtn),
    Z: common_vendor.p({
      title: "输入内容"
    }),
