...
if (!Array) {
  ...
  const _component_uv_qrcode = common_vendor.resolveComponent("uv-qrcode");
  (_component_uni_dateformat + _easycom_uni_icons2 + _easycom_uni_tag2 + _easycom_unicloud_db2 + _component_uv_qrcode)();
}
const _easycom_uni_icons = () => "../../uni_modules/uni-icons/components/uni-icons/uni-icons.js";
const _easycom_uni_tag = () => "../../uni_modules/uni-tag/components/uni-tag/uni-tag.js";
const _easycom_unicloud_db = () => "../../node-modules/@dcloudio/uni-components/lib/unicloud-db/unicloud-db.js";
if (!Math) {
  (_easycom_uni_icons + _easycom_uni_tag + _easycom_unicloud_db)();
}
